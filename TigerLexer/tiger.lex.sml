...
STRING | COMMENT | ESCAPE | INITIAL | FORMATSEQ
...
fun yyAction43 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentNestingLevel := !commentNestingLevel+1; continue()))
...
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; stringStartPos := yypos; continue()))
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN ESCAPE;  continue()))
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; let val s = !stringContent
                           in
                           stringContent := "";
...
fun yyAction60 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal format sequence " ^ yytext); continue())
      end
       ...
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  then yyQ119(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction61(strm, yyNO_MATCH)
                      else yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ89(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"f"
                  then yyQ88(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp < #"f"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ111(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ110(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ109(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
...
fun yyQ47 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ112(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ114(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ116 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ116(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ16(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #" "
              then yyQ19(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #" "
              then if inp = #"\t"
                  then yyQ19(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp = #"\n"
                  then yyQ20(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyAction57(strm, yyNO_MATCH)
            else if inp = #"\r"
              then yyQ20(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction44(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ17(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
              else yyAction44(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              then yyQ6(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
...
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    ...
    | FORMATSEQ => yyQ4(!(yystrm), yyNO_MATCH)
  (* end case *))
end
            end
	  in 
